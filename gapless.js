...
document.addEventListener('DOMContentLoaded', function(event) {
  llama.drawGraph('waveform_mp3_gapless', 'audio/mpeg', true, mp3_gapless_peaks);
  llama.drawGraph('waveform_mp3_gap', 'audio/mpeg', false, mp3_gap_peaks);
  llama.drawGraph('waveform_mp4_gapless', 'audio/mp4; codecs="mp4a.40.2"', true, aac_gapless_peaks);
});
